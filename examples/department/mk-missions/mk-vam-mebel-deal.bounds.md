# Рамки воркера mk: vam-mebel-deal (клиент «вам-мебель») — для /go-autonomous
...
- Edit(//home/rainor/brain/wiki/work/ai-dev/клиенты/вам-мебель/**)
- Write(//home/rainor/brain/wiki/work/ai-dev/клиенты/вам-мебель/**)
